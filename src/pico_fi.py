...
from lib import encode, randlower, delimit, unquote_to_bytes, LED
from lib.logging import cmt, log, str_print, atomic_print
...
class App:
    ...
    def repl(self, req: HTTP.Request, res: HTTP.Response):
        outputs = []
        def _print(*a, **k):
        ...
        try:
            ...
            log.info('repl\n' + command + '\n')
            exec(command, { 'print': _print }, self._repl_locals)
